...
const menuCategories: Record<string, MenuItem[]> = {
  "Flavor Cakes": [
    { name: "Chocolate Cake", price: "₹500", description: "Rich, moist chocolate sponge with smooth ganache", icon: Cake, popular: true },
    { name: "Choco Truffle Cake", price: "₹550", description: "Decadent chocolate truffle layers with dark ganache", icon: Heart, popular: true },
    { name: "Black Forest Cake", price: "₹600", description: "Cherry-filled chocolate cake with fresh cream", icon: Cake, popular: true },
    { name: "White Forest Cake", price: "₹600", description: "Delicate white chocolate cake with cream & cherries", icon: Heart },
    { name: "Vanilla Cake", price: "₹450", description: "Classic vanilla sponge with buttercream frosting", icon: Cake },
    { name: "Strawberry Cake", price: "₹550", description: "Fresh strawberry layered cake with whipped cream", icon: Heart },
    { name: "Blackcurrant Cake", price: "₹550", description: "Tangy blackcurrant flavored cake with cream frosting", icon: Star },
    { name: "Butterscotch Cake", price: "₹500", description: "Caramel butterscotch cake with crunchy praline", icon: Star },
    { name: "Mango Cake", price: "₹550", description: "Seasonal fresh mango cake with tropical cream layers", icon: Cake },
  ],
  "Brownies": [
    { name: "Classic Brownie", price: "₹250", description: "Rich, dense fudge brownie with a crackly top", icon: Heart, popular: true },
    { name: "Double Chocolate Brownie", price: "₹300", description: "Extra chocolatey brownie with chocolate chips", icon: Heart, popular: true },
    { name: "Triple Chocolate Brownie", price: "₹350", description: "Three layers of chocolate — dark, milk & white", icon: Star, popular: true },
    { name: "KitKat Brownie", price: "₹320", description: "Loaded with crunchy KitKat pieces on fudgy base", icon: Star },
    { name: "Oreo Brownie", price: "₹300", description: "Crushed Oreo cookies baked into rich brownie", icon: Heart },
    { name: "Nutella Brownie", price: "₹350", description: "Swirled with creamy Nutella and hazelnut crunch", icon: Star },
  ],
  "Healthy Brownies": [
    { name: "Ragi Brownie", price: "₹270", description: "Finger millet based brownie, naturally sweetened", icon: Leaf, popular: true },
    { name: "Karuppu Kavuni Brownie", price: "₹300", description: "Made with black rice — rich in antioxidants", icon: Leaf, popular: true },
    { name: "Kambu Brownie", price: "₹280", description: "Pearl millet brownie, wholesome & nutritious", icon: Leaf },
  ],
  "Tea Cake": [
    { name: "Vanilla Tea Cake", price: "₹350", description: "Light and fluffy vanilla loaf, perfect with tea", icon: Coffee, popular: true },
    { name: "Rose Milk Tea Cake", price: "₹380", description: "Fragrant rose-flavored cake with a hint of cardamom", icon: Coffee, popular: true },
  ],
  "Cookies": [
    { name: "Ragi Cookies", price: "₹160", description: "Crunchy finger millet cookies, healthy & delicious", icon: Cookie, popular: true },
    { name: "Wheat Cookies", price: "₹150", description: "Wholesome whole wheat butter cookies", icon: Cookie },
